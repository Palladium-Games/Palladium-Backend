...
- Supabase/Postgres-backed auth, bootstrap, public/private room access, room invite notifications, DM requests/acceptance, direct-message threads, automod mutes, and save APIs stay covered by direct tests.
