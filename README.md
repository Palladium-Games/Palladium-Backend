...
- frontend discovery for those commands now supports sibling checkouts named `Antarctic-Games`, `Antarctic-Frontend`, `antarctic-frontend`, `palladium-frontend`, or `frontend`
